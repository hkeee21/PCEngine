...
{
    // params boxes_a: (N, 6) [x1, y1, x2, y2, ry, batch_id]
    // params boxes_b: (M, 6)
    // params ans_overlap: (N, M)
...
int boxes_iou_3d_gpu(at::Tensor boxes_a, at::Tensor boxes_b, at::Tensor ans_iou)
{
    // params boxes_a: (N, 7) [x1, y1, x2, y2, ry, x3, y3]
    // params boxes_b: (M, 7)
    // params ans_overlap: (N, M)
...
int correspond_boxes_iou_3d_gpu(at::Tensor boxes_a, at::Tensor boxes_b, at::Tensor ans_iou)
{
    // params boxes_a: (N, 7) [x1, y1, x2, y2, ry, x3, y3]
    // params boxes_b: (N, 7)
    ...
    correspondBoxesiou3dLauncher(num_a, boxes_a_data, boxes_b_data, ans_iou_data);
...
{
    // params boxes: (N, 7) [x1, y1, x2, y2, ry, x3, y3]
    // params keep: (N)
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("boxes_iou_3d_gpu", &boxes_iou_3d_gpu, "oriented boxes iou (3d)");
    m.def("correspond_boxes_iou_3d_gpu", &correspond_boxes_iou_3d_gpu, "corresponded oriented boxes iou (3d)");
    m.def("nms_gpu", &nms_gpu, "oriented nms gpu");
    m.def("nms_3d_gpu", &nms_3d_gpu, "oriented nms gpu (3d)");
