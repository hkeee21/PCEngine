...
class ModelNet40Dataset(torch.utils.data.Dataset):
    def __init__(self, transform=None, item=None, root='AE-dataset/ModelNet40'):
        self.files = []
        self.data_objects = []
    ...
    def __getitem__(self, idx):
        ...
        pcs, inds = sparse_quantize(xyz, voxel_size=self.voxel_size, return_index=True)
        ...
        feats = np.random.uniform(0, 1, size=(input_nnz, 4)) 
